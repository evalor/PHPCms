...
$LANG['other_passport_info'] = '系统支持使用第三方账号登录。';
$LANG['input'] = '请输入';
$LANG['checkcode'] = '验证码';
$LANG['validate'] = '验证';
$LANG['user'] = '会员';
...
$LANG['sina_login_notice'] = '使用新浪微博连接登录系统,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录系统,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录系统,轻松使用盛大所有服务。';
